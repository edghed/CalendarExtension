...
export class EditEventDialog extends Controls_Dialog.ModalDialogO<IEventDialogOptions> {
    ...
    private _buildCalendarEventFromFields(): PromiseLike<any> {
        ...
        // Stocker la valeur du champ demi-journée (si sélectionnée)
        const halfDayValue = $("#halfDayChoice").val();
        this._calendarEvent.halfDay = halfDayValue ? (halfDayValue as "AM" | "PM") : undefined;
...
export class EditFreeFormEventControl extends Controls.Control<IEventControlOptions>
    ...
    private _createLayout() {
        ...
        // Champ pour demi-journée
        const $halfDaySelector = $("<div>")
        .addClass("half-day-selector")
        .append("<label>Demi-journée :</label>")
        .append(`
        <select id='halfDayChoice' class='half-day-dropdown'>
